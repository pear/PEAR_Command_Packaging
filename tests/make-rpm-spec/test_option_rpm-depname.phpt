...
// 1.0
$ret = $command->run('make-rpm-spec', array('rpm-depname'=>'php-pear(%s)'), array('../SOURCES/Net_SMTP-1.2.8.tgz'));
...
$phpunit->assertEquals(file_get_contents(dirname(__FILE__) . '/packagefiles/test_option_rpm-depname.spec'), file_get_contents($temp_path .
